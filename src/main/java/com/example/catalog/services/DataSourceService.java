...
public interface DataSourceService {
    ...
    //Album cearAlbum(Album album) throws IOException;
    ...
    Artist updateArtistById(String id, Artist updatedArtist) throws IOException;
    ...
    Song updateSongById(String id, Song updatedSong) throws IOException;
